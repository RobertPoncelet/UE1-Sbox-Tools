...
objroot = "..\\hla_addon_content\\models\\movers" # this is a bit messy but fuck it
...
glob_path = os.path.join("..", "hla_addon_content", "models", "movers", "*.obj")
objpaths = glob.glob(glob_path, recursive=True)
...
for objpath in objpaths:
    ...
    mdl = os.path.join("..", "hla_addon_content", "models", "movers", (mdl + ".vmdl"))
